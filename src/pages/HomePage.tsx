    ...
    <div className="w-full bg-[#FAF9F6]">
      ...
      <section className="relative w-full h-screen min-h-[640px] bg-[#121212] overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto flex flex-col items-center">
          <ClaLogoSvg
            variant="light"
            className="w-full max-w-[320px] sm:max-w-[440px] md:max-w-[560px] lg:max-w-[640px] h-auto drop-shadow-xl animate-fade-in"
          />
        </div>

        {/* Hero Subtle Architectural Anchors */}
        <div className="absolute bottom-8 left-8 hidden sm:flex flex-col text-white/70 text-[9px] uppercase font-mono tracking-[0.2em] z-10">
          <span className="text-[#FFC01D] font-medium">01 // Selected Architecture</span>
          <span>Creative Layers Architects</span>
        </div>

        <div className="absolute bottom-8 right-8 hidden sm:flex flex-col text-right text-white/70 text-[9px] uppercase font-mono tracking-[0.2em] z-10">
      ...
      <section className="py-20 lg:py-28 max-w-7xl mx-auto px-6 lg:px-12">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 pb-6 border-b border-[#E6E2DB]">
          <div>
